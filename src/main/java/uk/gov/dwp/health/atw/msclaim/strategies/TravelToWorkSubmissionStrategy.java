...
@Component
public class TravelToWorkSubmissionStrategy implements ClaimSubmissionStrategy {

  private final EmailNotificationService emailNotificationService;
  private final ClaimService claimService;

  public TravelToWorkSubmissionStrategy(EmailNotificationService emailNotificationService,
  ...
  public ClaimType getSupportedClaimType() {
    return ClaimType.TRAVEL_TO_WORK;
  }
}
