...
@Component
public class EquipmentOrAdaptationsSubmissionStrategy implements ClaimSubmissionStrategy {

  private final ClaimService claimService;
  private final EmailNotificationService emailNotificationService;

  public EquipmentOrAdaptationsSubmissionStrategy(
  ...
  public ClaimType getSupportedClaimType() {
    return ClaimType.EQUIPMENT_OR_ADAPTATION;
  }
}
